        ...
        <main>
            <form method="POST" action="{{ route('invoices.update', $invoice) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="invoice_number" name="invoice_number" required value="{{ old('invoice_number', $invoice->invoice_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="customer_name" name="customer_name" required value="{{ old('customer_name', $invoice->customer_name) }}">
                    @error('customer_name')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="invoice_date" name="invoice_date" required value="{{ old('invoice_date', $invoice->invoice_date) }}">
                    @error('invoice_date')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="total_amount" name="total_amount" required value="{{ old('total_amount', $invoice->total_amount) }}">
                    @error('total_amount')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
